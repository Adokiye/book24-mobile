...
export default function CruiseDetail({navigation, route}) {
  ...
  const {item, cruises} = route.params;
  ...
  const book = async () => {
    ...
    dispatch(setOrderType('cruise'));

    dispatch(
      setOrderImage(
        cruiseData.images && cruiseData.images[0] && cruiseData.images[0].url,
      ),
    );
    ...
    dispatch(setOrderName(cruiseData.name));
            ...
            <View
              style={[
                styles.contentBoxTop,
                {
                  ...
                  backgroundColor: colors.cruised,
                  ...
                  if (index < 4) {
                    return (
                      <HotelItem
                        ...
                        onPress={() =>
                          navigation.navigate('CruiseDetail', {item})
                        }
                      />
                    );
                  }
